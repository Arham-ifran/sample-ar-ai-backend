...
For development, you will need MongoDB v4.x, Node.js v16.18.1 (recommended) and a node global package, NPM, installed in your environement.
...
App backend would run on port 8080, if you provide PORT 8080 in .env
